...
namespace CommunalApp_Winforms.Model
{
    ...
    public class Gas
    {
        ...
        public Gas(double price, double volume, DateTime fromDate, DateTime toDate)
        {
            #region Проверка
            if (price <= 0)
            {
            ...
            if (volume <= 0)
            {
                throw new ArgumentException("Количество газа не может быть равен или меньше нуля", nameof(volume));
            }
